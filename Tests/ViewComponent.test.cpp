...
BEGIN_TEST_SUITE("elemental::ViewComponents")
{
	...
	class MockRenderer : public IRenderer
	{
		...
		{ circle_draw_count++; }
		void drawFilledRect(const Rectangle&, const Color&) override
		{ rect_draw_count++; }

		int circle_draw_count{ 0 };
		int rect_draw_count{ 0 };
	...
	TEST_CASE("CircleViewComponent construction via factory")
	{
		...
		auto&                                 comp =
		    factory.create(Point{ 100, 200 }, 16, Color{ 255, 0, 0 });
	...
	TEST_CASE("CircleViewComponent position mutation")
	{
		ComponentFactory<CircleViewComponent> factory;
		auto&                                 comp =
		    factory.create(Point{ 50, 75 }, 8, Color{ 255, 255, 255 });
	...
	TEST_CASE("CircleViewComponent produceDrawCommand returns FilledCircle")
	{
		...
		auto&                                 comp = factory.create(
		    Point{ 100, 100 }, 16, Color{ 255, 255, 255, 255 });
	...
	TEST_CASE("RectangleViewComponent construction via factory")
	{
		...
		auto&                                    comp = factory.create(
		    Point{ 20, 296 }, 16, 96, Color{ 255, 255, 255 });
	...
	TEST_CASE("RectangleViewComponent position and size mutation")
	{
		ComponentFactory<RectangleViewComponent> factory;
		auto&                                    comp = factory.create(
		    Point{ 0, 0 }, 10, 20, Color{ 255, 255, 255 });
	...
	TEST_CASE(
	    "RectangleViewComponent produceDrawCommand returns FilledRectangle")
	{
		ComponentFactory<RectangleViewComponent> factory;
		auto&                                    comp =
